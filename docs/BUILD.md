...
- 服务端：`scripts/fetch-sdk.py --version 具体版本或auto --output /tmp/sdk` 校验并解压 SDK；SDK 放在源码 Git 仓库之外。`server/tools/build-ocserv.sh` 同时构建所选 ocserv、原 LuCI 页、简体中文翻译与新增管理页。
